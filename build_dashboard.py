...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .tx-cat{display:inline-flex; align-items:center; gap:7px; max-width:100%; min-width:0;
  ...
  .tx-cat .cell-label{min-width:0; overflow:hidden; text-overflow:ellipsis; white-space:nowrap}
  .tx-cat .cat-select{background:transparent; border:0; color:inherit; font-size:12.5px; padding:0}
