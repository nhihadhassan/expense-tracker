...
<style>
  ...
  *{box-sizing:border-box}
  ...
  .card:hover{border-color:var(--line-strong); box-shadow:0 12px 28px -24px rgba(0,0,0,.7)}
  ...
  .sb-brand{display:flex; align-items:center; gap:11px; font-weight:800; font-size:20px;
    color:var(--success); padding:4px 8px 18px}
  .sb-brand .sb-logo{display:inline-flex; width:30px; height:30px; align-items:center; justify-content:center;
    border-radius:9px; background:linear-gradient(135deg,#8b5cf6,#4edea3); color:#0b1326; font-size:16px}
...
<div class="wrap">
  <header class="header-row">
    ...
    <div class="header-actions">
      ...
      <button class="btn" id="themeToggle" type="button" aria-pressed="false">Light theme</button>
...
function applyTheme(theme){
  ...
  if(button){ button.textContent=value==="light"?"Dark theme":"Light theme"; button.setAttribute("aria-pressed",value==="light"?"true":"false"); }
