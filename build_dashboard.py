...
<style>
  ...
  html[data-theme="light"] body{
    background:
      ...
      radial-gradient(900px 560px at 96% 6%, rgba(78,222,163,.12), transparent 44%),
      linear-gradient(180deg,#eef2ff,var(--bg) 340px);
  }
  ...
  html[data-theme="light"] .hero-card{background:linear-gradient(120deg,#6d28d9,#8b5cf6 62%)}
  ...
  *{box-sizing:border-box}
  ...
  body{
    ...
    background:
      radial-gradient(1100px 620px at 12% -6%, rgba(139,92,246,.16), transparent 46%),
      radial-gradient(900px 560px at 96% 6%, rgba(78,222,163,.10), transparent 44%),
      linear-gradient(180deg,#071a2e, var(--bg) 340px);
  ...
  .panel-restore{margin-left:auto; min-height:32px; padding:6px 10px}
  ...
  .insight-dismiss{margin-left:auto; flex:0 0 32px; width:32px; height:32px; padding:0}
  ...
  .admin-icon{width:34px; height:34px; min-height:34px; padding:0}
  ...
  .card,.kpi,.recur-kpi,.controls,.preview-kpi,.admin-section,.import-drop{
    background:var(--glass); backdrop-filter:blur(18px); -webkit-backdrop-filter:blur(18px);
  }
  .card,.controls,.admin-section{border-radius:20px}
  .kpi,.recur-kpi{border-radius:16px}
  .card{transition:transform .25s var(--ease-out),box-shadow .25s var(--ease-out),background .25s var(--ease-out);
    box-shadow:0 14px 34px -22px rgba(0,0,0,.7)}
  .card:hover{transform:translateY(-3px); background:rgba(28,43,60,.62);
    box-shadow:0 22px 44px -22px rgba(139,92,246,.4)}
  ...
  .btn.primary{background:linear-gradient(135deg,#8b5cf6,#a855f7); border-color:transparent; color:#fff;
  ...
  #sidebar{display:none; position:fixed; left:0; top:0; height:100vh; width:250px; z-index:40;
    ...
    background:rgba(13,28,45,.72); backdrop-filter:blur(22px); -webkit-backdrop-filter:blur(22px);
  ...
  .hero-card{position:relative; overflow:hidden; border-radius:24px; padding:30px 32px; margin-bottom:22px;
    background:linear-gradient(120deg, rgba(87,27,193,.36), rgba(28,43,60,.5) 62%);
  ...
  .hero-card::before{content:""; position:absolute; top:-90px; right:-60px; width:260px; height:260px;
    background:rgba(139,92,246,.35); filter:blur(80px); border-radius:50%}
  .hero-card::after{content:""; position:absolute; bottom:-100px; left:-40px; width:240px; height:240px;
    background:rgba(78,222,163,.16); filter:blur(80px); border-radius:50%}
