...
<style>
  ...
  *{box-sizing:border-box}
  ...
  body.analytics-view .grid{transform:scale(.96);transform-origin:top center;width:104.2%;margin-left:-2.1%;margin-bottom:-3.5%}
  ...
  @media(min-width:1080px){
    ...
    .wrap{margin-left:250px; max-width:1240px}
  }
  @media(max-width:640px){
