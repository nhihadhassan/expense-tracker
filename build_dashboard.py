...
<style>
  ...
  *{box-sizing:border-box}
  ...
  body.cashflow-page #mobileCashFlow .mobile-donut-wrap{width:min(100%,460px);min-height:380px}
  body.cashflow-page #mobileCashFlow .mobile-donut-wrap canvas{height:380px !important}
